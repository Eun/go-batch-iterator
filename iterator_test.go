...
func FuzzStaticSlice(f *testing.F) {
	testcases := []string{
		"",
		"A",
		"AB",
...
func TestNextBatchFunc(t *testing.T) {
	t.Parallel()
...
func TestNextBatchFuncAndEmptyResponse(t *testing.T) {
	t.Parallel()
...
func TestNextBatchFunctionRemovedInFlight(t *testing.T) {
	t.Parallel()
...
func TestNextAfterError(t *testing.T) {
	...
	var iter batchiterator.Iterator[string]
	iter.NextBatchFunc = func(ctx context.Context) (items []string, hasMoreItems bool, err error) {
		iter.NextBatchFunc = func(ctx context.Context) (items []string, hasMoreItems bool, err error) {
	...
	require.False(t, iter.Next(context.Background()))
	require.Nil(t, iter.Value())
	require.EqualError(t, iter.Error(), "unexpected error")
	require.False(t, iter.Next(context.Background()))
	require.Nil(t, iter.Value())
	require.EqualError(t, iter.Error(), "unexpected error")
}
...
func TestRateLimit(t *testing.T) {
	...
	t.Run("context canceled", func(t *testing.T) {
		...
		require.EqualError(t, iter.Error(), "context canceled")
	})
}
